...
export default function Authenticated({ auth, children }) {
    ...
    const [Menu, setMenu] = useState(
        dataMenu[localStorage.getItem("urlOpen").substr(1)]
    );
                                        ...
                                        <ul className="contacts">
                                            ...
                                            <li className="active dlab-chat-user">
                                                <div className="d-flex bd-highlight">
                                                    <div className="img_cont">
                                                        <img
                                                            src="./tamplate/images/avatar/1.jpg"
                                            ...
                                            <li className="dlab-chat-user">
                                                <div className="d-flex bd-highlight">
                                                    <div className="img_cont">
                                                        <img
                                                            src="./tamplate/images/avatar/2.jpg"
                                                            className="rounded-circle user_img"
                                                            alt=""
                                                        />
                                            ...
                                            <li className="dlab-chat-user">
                                                <div className="d-flex bd-highlight">
                                                    <div className="img_cont">
                                                        <img
                                                            src="./tamplate/images/avatar/3.jpg"
                                                            className="rounded-circle user_img"
                                                            alt=""
                                                        />
                                                        <span className="online_icon"></span>
                                            ...
                                            <li className="dlab-chat-user">
                                                <div className="d-flex bd-highlight">
                                                    <div className="img_cont">
                                                        <img
                                                            src="./tamplate/images/avatar/4.jpg"
                                                            className="rounded-circle user_img"
                                                            alt=""
                                                        />
                                                        <span className="online_icon offline"></span>
                                            ...
                                            <li className="dlab-chat-user">
                                                <div className="d-flex bd-highlight">
                                                    <div className="img_cont">
                                                        <img
                                                            src="./tamplate/images/avatar/5.jpg"
                                                            className="rounded-circle user_img"
                                                            alt=""
                                                        />
                                                        <span className="online_icon offline"></span>
